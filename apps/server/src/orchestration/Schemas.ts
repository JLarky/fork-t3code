import {
  ...
  ThreadQueuedMessageReleasedPayload as ContractsThreadQueuedMessageReleasedPayloadSchema,
...
export const ThreadQueuedMessageReleasedPayload = ContractsThreadQueuedMessageReleasedPayloadSchema;
